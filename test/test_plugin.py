...
def _qjit_with_mqt_plugin(**kwargs: Any) -> Any:  # noqa: ANN401
    """Create a qjit decorator that explicitly loads the MQT plugin.

    Returns:
        A qjit decorator configured with the MQT pass and dialect plugin.
    """

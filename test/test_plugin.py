...
def _verify_and_read_mlir_files() -> tuple[str, str, str]:
    ...
    """
    catalyst_mlir, mlir_to_qc, _mlir_to_catalyst = _get_mlir_file_paths()

    # if not catalyst_mlir.exists() or not mlir_to_qc.exists() or not mlir_to_catalyst.exists():
    if not catalyst_mlir.exists() or not mlir_to_qc.exists():
        mlir_dir = Path.cwd()
...
def _verify_roundtrip(
    ...
    mlir_before, mlir_after_qc = _verify_and_read_mlir_files()

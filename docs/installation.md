...
```console
python -m pip install mqt.core-plugins-catalyst
```
...
```console
python -c "import mqt.core-plugins-catalyst; print(mqt.core-plugins-catalyst.__version__)"
```
...
```console
pip install mqt.core-plugins-catalyst --no-binary mqt.core-plugins-catalyst
```
...
To use the MQT core-plugins-catalyst Python package in your project,
...
- install MQT core-plugins-catalyst on your system
...
because it lets you detect installed versions of MQT core-plugins-catalyst
...
1. Get the code: <!-- rumdl-disable-line MD013 -->
   ...
   [munich-quantum-toolkit/core-plugins-catalyst](https://github.com/munich-quantum-toolkit/core-plugins-catalyst)
...
6. If you plan to contribute to MQT core-plugins-catalyst,
...
MQT core-plugins-catalyst requires [MLIR](https://mlir.llvm.org/),
which is part of the [LLVM](https://llvm.org/) project,
to be available when building from source.
To successfully build MQT core-plugins-catalyst,
...
you can disable it by setting the {code}`BUILD_MQT_CORE-PLUGINS-CATALYST_MLIR` option
to {code}`OFF`.
This disables all MLIR-related features in MQT core-plugins-catalyst
